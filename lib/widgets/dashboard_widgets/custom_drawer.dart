...
UnloadingScreenController unloadingScreenController =
                  ...
                  child: ClipOval(
                    child: Image(
                      image: const AssetImage(
                          'assets/images/launcher-icon-tms.jpg'),
                      fit: BoxFit.cover,
                    ),
                    // child:
                  ),
...
class CustomListTile extends StatelessWidget {
  const CustomListTile(
      {Key? key, required this.name, required this.onTap, required this.image})
      : super(key: key);
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(
                        top: 25, bottom: 20, left: 30, right: 30),
                    child: Row(
                      children: [
                        Center(
                          child: Text(
                    ...
                    child: Column(
                      children: [
                        ...
                        Form(
                          ...
                          child: TextFormField(
                            controller:
                                stockUpdateController.thcNumberController,
                            decoration: InputDecoration(
                              // hintText: 'Username',
                              labelText: 'THC Number',
                              labelStyle: TextStyle(color: Colors.black),
                        ...
                        Container(
                          child: TextFormField(
                            controller:
                                stockUpdateController.stockUpdateFromDateCtl,
                            decoration: const InputDecoration(
                              // hintText: 'Username',
                              labelText: ' From Date',
                              labelStyle: TextStyle(color: Colors.black),
                            ...
                            onTap: () async {
                              ...
                              stockUpdateController
                                  .stockUpdateFromDateCtl.text = FromDate;
                            },
                          ),
                        ),
                        SizedBox(
                        ...
                        Container(
                          child: TextFormField(
                            controller:
                                stockUpdateController.stockUpdateToDateCtl,
                            decoration: const InputDecoration(
                              // hintText: 'Username',
                              labelText: ' TO Date',
                              labelStyle: TextStyle(color: Colors.black),
                            ...
                            onTap: () async {
                              ...
                              String toDate =
                                  DateFormat('yyyy-MM-dd').format(date!);
                              stockUpdateController.stockUpdateToDateCtl.text =
                                  toDate;
                            },
                          ),
                        ),
                              ...
                              await podController.podDocketListService(
                                getPodListReq: GetPodListReq(
                                    ...
                                    fromDate: DateFormat('dd MMM yyyy').format(
                                        DateTime.parse(
                                            ctrl1.arrivalsFromDateCtl.text)),
                                    toDate: DateFormat('dd MMM yyyy').format(
                                        DateTime.parse(
                                            ctrl1.arrivalsToDateCtl.text)),
                  ...
                  child: Column(
                    children: [
                      ...
                      TmsButton(
                        onPressed: () {
                          Get.back();
                          drsController.drsListDataStatus.value =
                              DataStatus.loading;
